...
- Awaited taint & public env (`await` passthrough, `NEXT_PUBLIC_*`): [docs/specs/awaited-taint-public-env.md](docs/specs/awaited-taint-public-env.md)
...
**2026-09-10 — Awaited Taint & Public Env** (`await`/`yield` pass taint
through; `NEXT_PUBLIC_*` env reads are public by design), and
